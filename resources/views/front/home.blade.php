    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-xl-8">
                <h1>Find Your Best Look at Regent Wear</h1>
                <p>We have great clothes for every style.</p>
                <div class="banner-btn mt-5"><a href="" class="btn btn-primary mb-4 mb-sm-0">Shoping Now</a></div>
            </div>
        </div>
    </div>
</section>
